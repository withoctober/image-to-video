  ...
  return (
    <Menu positioning={{ placement: 'top-end' }}>
      <MenuTrigger className="flex w-full items-center gap-2 border-none bg-transparent p-0">
        <span className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-primary-500 bg-opacity-10 text-2xl text-primary-500">
          {user.image ? (
            <Image
              src={user.image}
              alt={user.name ?? ''}
