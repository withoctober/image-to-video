...
export const UserVerificationTokenScalarFieldEnumSchema = z.enum([
  "id",
  "userId",
  "token",
  "expires",
...
export const UserOneTimePasswordScalarFieldEnumSchema = z.enum([
  "id",
  "userId",
  "code",
  "type",
...
export const TeamMembershipScalarFieldEnumSchema = z.enum([
  "id",
  "teamId",
  "userId",
  "role",
...
export const TeamInvitationScalarFieldEnumSchema = z.enum([
  "id",
  "teamId",
  "email",
  "role",
...
export const UserOneTimePasswordTypeSchema = z.enum([
  "SIGNUP",
  "LOGIN",
  "PASSWORD_RESET",
]);

export type UserOneTimePasswordTypeType =
  `${z.infer<typeof UserOneTimePasswordTypeSchema>}`;
